...
const SharedHeader: FC<{ documentProps: PageContext["documentProps"] }> = ({ documentProps }) => (
    <Helmet>
        <title>{documentProps?.title || "Daniel Bannert"}</title>
        <meta
            name="description"
            content={documentProps?.description || "A Software Engineer, Consultant and Open Source Enthusiast from Regensburg (Germany)."}
        />

        <meta name="author" content="Daniel Bannert" />
        <meta name="revisit-after" content="7 days" />

        <meta property="og:title" content={documentProps?.title || "Daniel Bannert"} />
        <meta
