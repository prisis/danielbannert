...
export const Page = ({ is404 }: { is404: boolean }) => {
    if (is404) {
        return (
            <div className="container mx-auto px-8 pb-64 pt-32 md:px-0">
                <div className="flex flex-col items-center justify-center gap-16 lg:flex-row lg:gap-28">
                    <div className="w-full lg:w-1/2">
                        <svg viewBox="0 0 1120.59226 777.91584" xmlns="http://www.w3.org/2000/svg">
                            <title>not found</title>
                            <circle cx="212.59226" cy="103" fill="#84cc16" r="64" />
                            <path
                            ...
                            <rect fill="#2f2e41" height="43" transform="translate(-31.32451 -62.31008) rotate(0.67509)" width="24" x="99.80546" y="689.02332" />
                            <rect
                                fill="#2f2e41"
                                height="43"
                            ...
                            <rect
                                ...
                                y="677.72286"
                            />
                            <ellipse cx="767.887" cy="732.00275" fill="#2f2e41" rx="20" ry="7.5" transform="translate(-220.8593 196.83312) rotate(-17.08345)" />
                            <ellipse
                                cx="813.47537"
                                cy="716.94619"
                                fill="#2f2e41"
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <p className="py-2 text-base text-gray-800 dark:text-white">
                            Sorry about that! Please visit the main page again to get where you need to go.
                        </p>
                        <a
                            className="my-4 inline-block w-full rounded-md bg-lime-500 px-1 py-5 hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-600/50 sm:px-16 lg:w-auto"
                            href="/"
                        >
                            Go back to Homepage
                        </a>
