export const Page = ({ is404 }: { is404: boolean }) => {
    if (is404) {
        return (
            <section className="relative px-2 py-32 md:px-0">
                <div className="container mx-auto max-w-6xl px-8 xl:px-5">
                    <div className="flex flex-col items-center justify-center gap-16 lg:flex-row lg:gap-28">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <a
                                className="my-4 inline-block w-full rounded-md bg-lime-500 px-1 py-5 hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-600 focus:ring-opacity-50 sm:px-16 lg:w-auto"
                                href="/"
                            >
                                Go back to Homepage
                            </a>
