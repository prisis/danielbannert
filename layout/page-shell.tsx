    ...
    <StrictMode>
        <PageContextProvider pageContext={pageContext}>
            <div className="font-feature-default relative min-h-screen w-full antialiased font-inter">
                <div className="container mx-auto flex h-48 max-w-5xl items-end px-8 pb-10 2xl:max-w-7xl 2xl:px-0">
                    <a href="/" title="Daniel Bannert">
                        <svg className="mt-2.5 h-8 w-8 hover:text-lime-500" fill="none" viewBox="0 0 159 171" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div className="relative flex w-full flex-col items-center justify-center align-middle">{children}</div>
                <Footer />
            </div>
            <AnimatedCursor
                innerScale={1}
