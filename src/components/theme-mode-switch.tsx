...
const PcIcon: FC<{ selected: boolean } & SVGProps<SVGSVGElement>> = ({ selected, ...properties }) => (
    ...
    <svg viewBox="0 0 24 24" fill="none" {...properties}>
        <path
            ...
            className={selected ? "stroke-sky-500 fill-sky-400/20" : "stroke-zinc-400 dark:stroke-zinc-500"}
        />
        <path
...
export const ThemeSelect = () => {
    ...
    return (
        <div className="flex items-center justify-between">
            ...
            <div className="relative flex items-center ring-1 ring-zinc-900/10 rounded-lg shadow-sm p-2 text-zinc-700 font-semibold dark:bg-zinc-600 dark:ring-0 dark:highlight-white/5">
