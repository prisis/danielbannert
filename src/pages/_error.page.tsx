...
const Error = ({ is404 }: { is404: boolean }) => {
    if (is404) {
        return (
            <section className="px-2 py-32 md:px-0 relative">
                <div className="container max-w-6xl px-8 mx-auto xl:px-5">
                    <div className="flex items-center flex-col justify-center lg:flex-row gap-16 lg:gap-28">
                        <div className="w-full lg:w-1/2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1120.59226 777.91584">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <a
                                href="/"
                                className="inline-block w-full lg:w-auto my-4 rounded-md px-1 sm:px-16 py-5 bg-lime-500 hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-600 focus:ring-opacity-50"
                            >
                                Go back to Homepage
                            </a>
                        </div>
