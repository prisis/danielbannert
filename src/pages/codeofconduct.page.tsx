        ...
        <section className="px-2 py-32 md:px-0 relative">
            <div className="container max-w-6xl px-5 mx-auto space-y-6">
                ...
                <p>
                    ...
                    <Link href="mailto:d.bannert@anolilab.de">d.bannert@anolilab.de</Link>. All complaints will be reviewed and investigated promptly and
                    fairly.
                </p>
                ...
                <p>
                    ...
                    unsolicited interaction with those enforcing the Code of Conduct, for a specified period of time. This includes avoiding interactions in
                ...
                <p>
                    ...
                    of time. No public or private interaction with the people involved, including unsolicited interaction with those enforcing the Code of
                ...
                <p>
                    This Code of Conduct is adapted from the <Link href="https://www.contributor-covenant.org">Contributor Covenant</Link>, version 2.0,
                    available at{" "}
